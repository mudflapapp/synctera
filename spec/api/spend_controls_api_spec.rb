...
# Unit tests for Synctera::SpendControlsApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'SpendControlsApi' do
  before do
  ...
  describe 'test an instance of SpendControlsApi' do
    it 'should create an instance of SpendControlsApi' do
      expect(@api_instance).to be_instance_of(Synctera::SpendControlsApi)
    end
  end
  ...
  # @param spend_control Details of the spend control to create
