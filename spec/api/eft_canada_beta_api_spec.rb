...
# Unit tests for Synctera::EFTCanadaBetaApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'EFTCanadaBetaApi' do
  before do
  ...
  describe 'test an instance of EFTCanadaBetaApi' do
    it 'should create an instance of EFTCanadaBetaApi' do
      expect(@api_instance).to be_instance_of(Synctera::EFTCanadaBetaApi)
    end
  end
