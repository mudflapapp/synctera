...
# Unit tests for Synctera::AccountSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::AccountSummary do
  let(:instance) { Synctera::AccountSummary.new }

  describe 'test an instance of AccountSummary' do
    it 'should create an instance of AccountSummary' do
      expect(instance).to be_instance_of(Synctera::AccountSummary)
    end
  end
