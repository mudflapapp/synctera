...
# Unit tests for Synctera::Lookup3dsRequestSdk
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::Lookup3dsRequestSdk do
  let(:instance) { Synctera::Lookup3dsRequestSdk.new }

  describe 'test an instance of Lookup3dsRequestSdk' do
    it 'should create an instance of Lookup3dsRequestSdk' do
      expect(instance).to be_instance_of(Synctera::Lookup3dsRequestSdk)
    end
  end
