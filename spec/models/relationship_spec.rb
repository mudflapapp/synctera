...
# Unit tests for Synctera::Relationship
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::Relationship do
  let(:instance) { Synctera::Relationship.new }

  describe 'test an instance of Relationship' do
    it 'should create an instance of Relationship' do
      expect(instance).to be_instance_of(Synctera::Relationship)
    end
  end
