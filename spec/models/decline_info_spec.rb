...
# Unit tests for Synctera::DeclineInfo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::DeclineInfo do
  let(:instance) { Synctera::DeclineInfo.new }

  describe 'test an instance of DeclineInfo' do
    it 'should create an instance of DeclineInfo' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Synctera::DeclineInfo)
    end
  end
