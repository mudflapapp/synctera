...
# Unit tests for Synctera::AccountLineOfCredit
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::AccountLineOfCredit do
  let(:instance) { Synctera::AccountLineOfCredit.new }

  describe 'test an instance of AccountLineOfCredit' do
    it 'should create an instance of AccountLineOfCredit' do
      expect(instance).to be_instance_of(Synctera::AccountLineOfCredit)
    end
  end
