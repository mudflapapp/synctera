...
# Unit tests for Synctera::RelationshipList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::RelationshipList do
  let(:instance) { Synctera::RelationshipList.new }

  describe 'test an instance of RelationshipList' do
    it 'should create an instance of RelationshipList' do
      expect(instance).to be_instance_of(Synctera::RelationshipList)
    end
  end
