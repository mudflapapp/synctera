...
# Unit tests for Synctera::DocumentList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::DocumentList do
  let(:instance) { Synctera::DocumentList.new }

  describe 'test an instance of DocumentList' do
    it 'should create an instance of DocumentList' do
      expect(instance).to be_instance_of(Synctera::DocumentList)
    end
  end
