...
# Unit tests for Synctera::EftCaBase
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::EftCaBase do
  let(:instance) { Synctera::EftCaBase.new }

  describe 'test an instance of EftCaBase' do
    it 'should create an instance of EftCaBase' do
      expect(instance).to be_instance_of(Synctera::EftCaBase)
    end
  end
