...
# Unit tests for Synctera::CustomerList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::CustomerList do
  let(:instance) { Synctera::CustomerList.new }

  describe 'test an instance of CustomerList' do
    it 'should create an instance of CustomerList' do
      expect(instance).to be_instance_of(Synctera::CustomerList)
    end
  end
