...
# Unit tests for Synctera::RewardResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::RewardResponse do
  let(:instance) { Synctera::RewardResponse.new }

  describe 'test an instance of RewardResponse' do
    it 'should create an instance of RewardResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Synctera::RewardResponse)
    end
  end
