...
# Unit tests for Synctera::PaginatedResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::PaginatedResponse do
  let(:instance) { Synctera::PaginatedResponse.new }

  describe 'test an instance of PaginatedResponse' do
    it 'should create an instance of PaginatedResponse' do
      expect(instance).to be_instance_of(Synctera::PaginatedResponse)
    end
  end
