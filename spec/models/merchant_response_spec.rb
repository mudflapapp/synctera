...
# Unit tests for Synctera::MerchantResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::MerchantResponse do
  let(:instance) { Synctera::MerchantResponse.new }

  describe 'test an instance of MerchantResponse' do
    it 'should create an instance of MerchantResponse' do
      expect(instance).to be_instance_of(Synctera::MerchantResponse)
    end
  end
