...
# Unit tests for Synctera::Verification
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::Verification do
  let(:instance) { Synctera::Verification.new }

  describe 'test an instance of Verification' do
    it 'should create an instance of Verification' do
      expect(instance).to be_instance_of(Synctera::Verification)
    end
  end
