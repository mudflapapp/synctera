...
# Unit tests for Synctera::InternalTransferResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::InternalTransferResponse do
  let(:instance) { Synctera::InternalTransferResponse.new }

  describe 'test an instance of InternalTransferResponse' do
    it 'should create an instance of InternalTransferResponse' do
      expect(instance).to be_instance_of(Synctera::InternalTransferResponse)
    end
  end
  ...
  describe 'test attribute "status"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CANCELED", "COMPLETE", "EXPIRED", "PENDING"])
      # validator.allowable_values.each do |value|
