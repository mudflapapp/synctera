...
# Unit tests for Synctera::DeleteResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::DeleteResponse do
  let(:instance) { Synctera::DeleteResponse.new }

  describe 'test an instance of DeleteResponse' do
    it 'should create an instance of DeleteResponse' do
      expect(instance).to be_instance_of(Synctera::DeleteResponse)
    end
  end
