...
# Unit tests for Synctera::OutgoingAchRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::OutgoingAchRequest do
  let(:instance) { Synctera::OutgoingAchRequest.new }

  describe 'test an instance of OutgoingAchRequest' do
    it 'should create an instance of OutgoingAchRequest' do
      expect(instance).to be_instance_of(Synctera::OutgoingAchRequest)
    end
  end
  ...
  describe 'test attribute "sec_code"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["CCD", "WEB"])
      # validator.allowable_values.each do |value|
