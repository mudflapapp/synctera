...
# Unit tests for Synctera::Payment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::Payment do
  let(:instance) { Synctera::Payment.new }

  describe 'test an instance of Payment' do
    it 'should create an instance of Payment' do
      expect(instance).to be_instance_of(Synctera::Payment)
    end
  end
  ...
  describe 'test attribute "payment_schedule_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
