...
# Unit tests for Synctera::ApplicationList
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::ApplicationList do
  let(:instance) { Synctera::ApplicationList.new }

  describe 'test an instance of ApplicationList' do
    it 'should create an instance of ApplicationList' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Synctera::ApplicationList)
    end
  end
