...
# Unit tests for Synctera::Transaction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::Transaction do
  let(:instance) { Synctera::Transaction.new }

  describe 'test an instance of Transaction' do
    it 'should create an instance of Transaction' do
      expect(instance).to be_instance_of(Synctera::Transaction)
    end
  end
