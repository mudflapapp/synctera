...
# Unit tests for Synctera::EnhancedRawDetails
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Synctera::EnhancedRawDetails do
  let(:instance) { Synctera::EnhancedRawDetails.new }

  describe 'test an instance of EnhancedRawDetails' do
    it 'should create an instance of EnhancedRawDetails' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Synctera::EnhancedRawDetails)
    end
  end
