...
require 'synctera/models/base_cash_pickup'
require 'synctera/models/base_disclosure'
require 'synctera/models/base_person'
require 'synctera/models/base_person1'
...
require 'synctera/models/cash_pickup'
require 'synctera/models/cash_pickup_list'
require 'synctera/models/cash_pickup_patch_request'
require 'synctera/models/cash_pickup_post_request'
require 'synctera/models/cash_pickup_status'
...
require 'synctera/models/document'
...
require 'synctera/models/employment'
require 'synctera/models/employment_list'
require 'synctera/models/encryption'
...
require 'synctera/models/patch_document'
...
require 'synctera/models/relationship1'
...
require 'synctera/models/risk_rating'
require 'synctera/models/risk_rating_list'
...
require 'synctera/models/status'
require 'synctera/models/status1'
require 'synctera/models/status2'
...
require 'synctera/models/verification_type1'
...
require 'synctera/api/cash_pickups_alpha_api'
...
require 'synctera/api/eft_canada_alpha_api'
