...
module Synctera
  class CardTransactionSimulationsApi
    ...
    # @param l2l3_model [L2l3Model] L2l3 details
    # @param [Hash] opts the optional parameters
    # @return [Object]
    def simulatel2l3(l2l3_model, opts = {})
      data, _status_code, _headers = simulatel2l3_with_http_info(l2l3_model, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Object, Integer, Hash)>] Object data, response status code and response headers
    def simulatel2l3_with_http_info(l2l3_model, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardTransactionSimulationsApi.simulatel2l3 ...'
      end
      # verify the required parameter 'l2l3_model' is set
      if @api_client.config.client_side_validation && l2l3_model.nil?
        fail ArgumentError, "Missing the required parameter 'l2l3_model' when calling CardTransactionSimulationsApi.simulatel2l3"
      end
      # resource path
      local_var_path = '/cards/transaction_simulations/clearing/l2l3'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(l2l3_model)
      ...
      new_options = opts.merge(
        :operation => :"CardTransactionSimulationsApi.simulatel2l3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardTransactionSimulationsApi#simulatel2l3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
