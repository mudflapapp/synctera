...
module Synctera
  class DocumentsApi
    ...
    # @option opts [String] :batch_id The ID of the batch that the document belongs to
    ...
    def create_document_with_http_info(file, opts = {})
      ...
      form_params['batch_id'] = opts[:'batch_id'] if !opts[:'batch_id'].nil?
    ...
    # @option opts [String] :batch_id Return documents that are related to batch with the specified ID
