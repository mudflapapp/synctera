...
module Synctera
  class AccountsApi
    ...
    # @param relationship [Relationship] Account relationship object
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [RelationshipResponse]
    def create_account_relationship(account_id, relationship, opts = {})
      data, _status_code, _headers = create_account_relationship_with_http_info(account_id, relationship, opts)
      data
    end
    ...
    def create_account_relationship_with_http_info(account_id, relationship, opts = {})
      if @api_client.config.debugging
    ...
    # @param relationship_id [String] Relationship ID of the account associate with the account entity
    # @param account_id [String] Unique identifier for the account.
    # @param relationship [Relationship] Account relationship to be updated
    # @param [Hash] opts the optional parameters
    # @return [RelationshipResponse]
    def update_account_relationship(relationship_id, account_id, relationship, opts = {})
      data, _status_code, _headers = update_account_relationship_with_http_info(relationship_id, account_id, relationship, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(RelationshipResponse, Integer, Hash)>] RelationshipResponse data, response status code and response headers
    def update_account_relationship_with_http_info(relationship_id, account_id, relationship, opts = {})
      if @api_client.config.debugging
