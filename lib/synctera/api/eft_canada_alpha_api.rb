  ...
  class EFTCanadaAlphaApi
    ...
    def create_eftca_transfer_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EFTCanadaAlphaApi.create_eftca_transfer ...'
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(opts[:'eft_ca_post'])
      ...
      new_options = opts.merge(
        :operation => :"EFTCanadaAlphaApi.create_eftca_transfer",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EFTCanadaAlphaApi#create_eftca_transfer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_eftca_transfer_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EFTCanadaAlphaApi.get_eftca_transfer ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EFTCanadaAlphaApi.get_eftca_transfer"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EFTCanadaAlphaApi.get_eftca_transfer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EFTCanadaAlphaApi#get_eftca_transfer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_eftca_transfers_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EFTCanadaAlphaApi.get_eftca_transfers ...'
      end
      if @api_client.config.client_side_validation && !opts[:'min_amount'].nil? && opts[:'min_amount'] < 1
        fail ArgumentError, 'invalid value for "opts[:"min_amount"]" when calling EFTCanadaAlphaApi.get_eftca_transfers, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'max_amount'].nil? && opts[:'max_amount'] < 1
        fail ArgumentError, 'invalid value for "opts[:"max_amount"]" when calling EFTCanadaAlphaApi.get_eftca_transfers, must be greater than or equal to 1.'
      end
      ...
      new_options = opts.merge(
        :operation => :"EFTCanadaAlphaApi.get_eftca_transfers",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EFTCanadaAlphaApi#get_eftca_transfers\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def patch_eftca_transfer_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EFTCanadaAlphaApi.patch_eftca_transfer ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EFTCanadaAlphaApi.patch_eftca_transfer"
      end
      # resource path
      local_var_path = '/eft_ca/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EFTCanadaAlphaApi.patch_eftca_transfer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EFTCanadaAlphaApi#patch_eftca_transfer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [EftCaResponse]
    def return_eftca_transfer(id, opts = {})
      data, _status_code, _headers = return_eftca_transfer_with_http_info(id, opts)
      data
    end
    ...
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [Array<(EftCaResponse, Integer, Hash)>] EftCaResponse data, response status code and response headers
    def return_eftca_transfer_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EFTCanadaAlphaApi.return_eftca_transfer ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling EFTCanadaAlphaApi.return_eftca_transfer"
      end
      # resource path
      local_var_path = '/eft_ca/{id}/return'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"EFTCanadaAlphaApi.return_eftca_transfer",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EFTCanadaAlphaApi#return_eftca_transfer\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
