...
module Synctera
  class SpendControlsBetaApi
    ...
    # @param spend_control_creation_request [SpendControlCreationRequest] Details of the spend control to create
    # @param [Hash] opts the optional parameters
    # @return [SpendControlResponse]
    def create_spend_control(spend_control_creation_request, opts = {})
      data, _status_code, _headers = create_spend_control_with_http_info(spend_control_creation_request, opts)
      data
    end
    ...
    def create_spend_control_with_http_info(spend_control_creation_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SpendControlsBetaApi.create_spend_control ...'
      end
      # verify the required parameter 'spend_control_creation_request' is set
      if @api_client.config.client_side_validation && spend_control_creation_request.nil?
        fail ArgumentError, "Missing the required parameter 'spend_control_creation_request' when calling SpendControlsBetaApi.create_spend_control"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(spend_control_creation_request)
      ...
      new_options = opts.merge(
        :operation => :"SpendControlsBetaApi.create_spend_control",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SpendControlsBetaApi#create_spend_control\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def get_spend_control_with_http_info(spend_control_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SpendControlsBetaApi.get_spend_control ...'
      end
      # verify the required parameter 'spend_control_id' is set
      if @api_client.config.client_side_validation && spend_control_id.nil?
        fail ArgumentError, "Missing the required parameter 'spend_control_id' when calling SpendControlsBetaApi.get_spend_control"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"SpendControlsBetaApi.get_spend_control",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SpendControlsBetaApi#get_spend_control\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_spend_controls_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SpendControlsBetaApi.list_spend_controls ...'
      end
      if @api_client.config.client_side_validation && !opts[:'amount_limit_gte'].nil? && opts[:'amount_limit_gte'] < 0
        fail ArgumentError, 'invalid value for "opts[:"amount_limit_gte"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'amount_limit_lte'].nil? && opts[:'amount_limit_lte'] < 0
        fail ArgumentError, 'invalid value for "opts[:"amount_limit_lte"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'num_related_accounts_gte'].nil? && opts[:'num_related_accounts_gte'] < 0
        fail ArgumentError, 'invalid value for "opts[:"num_related_accounts_gte"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'num_related_accounts'].nil? && opts[:'num_related_accounts'] < 0
        fail ArgumentError, 'invalid value for "opts[:"num_related_accounts"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 0.'
      end

      if @api_client.config.client_side_validation && !opts[:'num_related_accounts_lte'].nil? && opts[:'num_related_accounts_lte'] < 0
        fail ArgumentError, 'invalid value for "opts[:"num_related_accounts_lte"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 0.'
      end
      ...
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 1.'
      end

      if @api_client.config.client_side_validation && !opts[:'amount_limit'].nil? && opts[:'amount_limit'] < 0
        fail ArgumentError, 'invalid value for "opts[:"amount_limit"]" when calling SpendControlsBetaApi.list_spend_controls, must be greater than or equal to 0.'
      end
      ...
      new_options = opts.merge(
        :operation => :"SpendControlsBetaApi.list_spend_controls",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SpendControlsBetaApi#list_spend_controls\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_spend_control_with_http_info(spend_control_id, spend_control_update_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SpendControlsBetaApi.update_spend_control ...'
      end
      # verify the required parameter 'spend_control_id' is set
      if @api_client.config.client_side_validation && spend_control_id.nil?
        fail ArgumentError, "Missing the required parameter 'spend_control_id' when calling SpendControlsBetaApi.update_spend_control"
      end
      ...
      if @api_client.config.client_side_validation && spend_control_update_request.nil?
        fail ArgumentError, "Missing the required parameter 'spend_control_update_request' when calling SpendControlsBetaApi.update_spend_control"
      end
      # resource path
      local_var_path = '/spend_controls/{spend_control_id}'.sub('{' + 'spend_control_id' + '}', CGI.escape(spend_control_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"SpendControlsBetaApi.update_spend_control",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SpendControlsBetaApi#update_spend_control\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
