...
module Synctera
  class DigitalWalletTokensBetaApi
    ...
    # @param apple_digital_wallet_provision_request [AppleDigitalWalletProvisionRequest] Request to provision digital wallet card data to pass to Apple Pay digital wallet. &gt; ⚠️ Cannot be used outside of production. 
    ...
    def create_digital_wallet_apple_with_http_info(card_id, apple_digital_wallet_provision_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DigitalWalletTokensBetaApi.create_digital_wallet_apple ...'
      end
      # verify the required parameter 'card_id' is set
      if @api_client.config.client_side_validation && card_id.nil?
        fail ArgumentError, "Missing the required parameter 'card_id' when calling DigitalWalletTokensBetaApi.create_digital_wallet_apple"
      end
      ...
      if @api_client.config.client_side_validation && apple_digital_wallet_provision_request.nil?
        fail ArgumentError, "Missing the required parameter 'apple_digital_wallet_provision_request' when calling DigitalWalletTokensBetaApi.create_digital_wallet_apple"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DigitalWalletTokensBetaApi.create_digital_wallet_apple",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DigitalWalletTokensBetaApi#create_digital_wallet_apple\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # > 🚧 Beta > This is a Beta endpoint. Feedback from the community is welcome. We may make breaking changes to this endpoint. 
    # @param card_id [String] 
    # @param google_digital_wallet_provision_request [GoogleDigitalWalletProvisionRequest] Request to provision digital wallet card data to pass to Google Pay digital wallet. &gt; ⚠️ Cannot be used outside of production. 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    ...
    def create_digital_wallet_google_with_http_info(card_id, google_digital_wallet_provision_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DigitalWalletTokensBetaApi.create_digital_wallet_google ...'
      end
      # verify the required parameter 'card_id' is set
      if @api_client.config.client_side_validation && card_id.nil?
        fail ArgumentError, "Missing the required parameter 'card_id' when calling DigitalWalletTokensBetaApi.create_digital_wallet_google"
      end
      ...
      if @api_client.config.client_side_validation && google_digital_wallet_provision_request.nil?
        fail ArgumentError, "Missing the required parameter 'google_digital_wallet_provision_request' when calling DigitalWalletTokensBetaApi.create_digital_wallet_google"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DigitalWalletTokensBetaApi.create_digital_wallet_google",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DigitalWalletTokensBetaApi#create_digital_wallet_google\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_digital_wallet_token_with_http_info(digital_wallet_token_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DigitalWalletTokensBetaApi.get_digital_wallet_token ...'
      end
      ...
      if @api_client.config.client_side_validation && digital_wallet_token_id.nil?
        fail ArgumentError, "Missing the required parameter 'digital_wallet_token_id' when calling DigitalWalletTokensBetaApi.get_digital_wallet_token"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"DigitalWalletTokensBetaApi.get_digital_wallet_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DigitalWalletTokensBetaApi#get_digital_wallet_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_digital_wallet_tokens_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DigitalWalletTokensBetaApi.list_digital_wallet_tokens ...'
      end
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling DigitalWalletTokensBetaApi.list_digital_wallet_tokens, must be greater than or equal to 1.'
      end
      ...
      new_options = opts.merge(
        :operation => :"DigitalWalletTokensBetaApi.list_digital_wallet_tokens",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DigitalWalletTokensBetaApi#list_digital_wallet_tokens\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def update_digital_wallet_token_status_with_http_info(digital_wallet_token_id, digital_wallet_token_edit_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DigitalWalletTokensBetaApi.update_digital_wallet_token_status ...'
      end
      # verify the required parameter 'digital_wallet_token_id' is set
      if @api_client.config.client_side_validation && digital_wallet_token_id.nil?
        fail ArgumentError, "Missing the required parameter 'digital_wallet_token_id' when calling DigitalWalletTokensBetaApi.update_digital_wallet_token_status"
      end
      ...
      if @api_client.config.client_side_validation && digital_wallet_token_edit_request.nil?
        fail ArgumentError, "Missing the required parameter 'digital_wallet_token_edit_request' when calling DigitalWalletTokensBetaApi.update_digital_wallet_token_status"
      end
      # resource path
      local_var_path = '/cards/digital_wallet_tokens/{digital_wallet_token_id}'.sub('{' + 'digital_wallet_token_id' + '}', CGI.escape(digital_wallet_token_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DigitalWalletTokensBetaApi.update_digital_wallet_token_status",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DigitalWalletTokensBetaApi#update_digital_wallet_token_status\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
