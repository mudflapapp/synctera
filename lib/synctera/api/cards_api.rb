...
module Synctera
  class CardsApi
    ...
    # @param create_three_ds_decision_gateway_request [CreateThreeDsDecisionGatewayRequest] The 3DS Decision Gateway to be created
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [ThreeDsDecisionGatewayResponse]
    def create_three_ds_decision_gateway(create_three_ds_decision_gateway_request, opts = {})
      data, _status_code, _headers = create_three_ds_decision_gateway_with_http_info(create_three_ds_decision_gateway_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [Array<(ThreeDsDecisionGatewayResponse, Integer, Hash)>] ThreeDsDecisionGatewayResponse data, response status code and response headers
    def create_three_ds_decision_gateway_with_http_info(create_three_ds_decision_gateway_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.create_three_ds_decision_gateway ...'
      end
      # verify the required parameter 'create_three_ds_decision_gateway_request' is set
      if @api_client.config.client_side_validation && create_three_ds_decision_gateway_request.nil?
        fail ArgumentError, "Missing the required parameter 'create_three_ds_decision_gateway_request' when calling CardsApi.create_three_ds_decision_gateway"
      end
      # resource path
      local_var_path = '/cards/three_ds_decision_gateways'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(create_three_ds_decision_gateway_request)

      # return_type
      return_type = opts[:debug_return_type] || 'ThreeDsDecisionGatewayResponse'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"CardsApi.create_three_ds_decision_gateway",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#create_three_ds_decision_gateway\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def get_card_image_data_with_http_info(card_image_id, opts = {})
      ...
      header_params = opts[:header_params] || {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['image/jpeg', 'application/json'])
    ...
    # @param [Hash] opts the optional parameters
    # @return [ThreeDsDecisionGatewayResponse]
    def get_three_ds_decision_gateway(id, opts = {})
      data, _status_code, _headers = get_three_ds_decision_gateway_with_http_info(id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(ThreeDsDecisionGatewayResponse, Integer, Hash)>] ThreeDsDecisionGatewayResponse data, response status code and response headers
    def get_three_ds_decision_gateway_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.get_three_ds_decision_gateway ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CardsApi.get_three_ds_decision_gateway"
      end
      # resource path
      local_var_path = '/cards/three_ds_decision_gateways/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"CardsApi.get_three_ds_decision_gateway",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#get_three_ds_decision_gateway\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param card_id [String] 
    # @param widget_type [CardWidgetType] 
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [WidgetToken]
    def get_widget_access_token(card_id, widget_type, opts = {})
      data, _status_code, _headers = get_widget_access_token_with_http_info(card_id, widget_type, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [Array<(WidgetToken, Integer, Hash)>] WidgetToken data, response status code and response headers
    def get_widget_access_token_with_http_info(card_id, widget_type, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.get_widget_access_token ...'
      end
      # verify the required parameter 'card_id' is set
      if @api_client.config.client_side_validation && card_id.nil?
        fail ArgumentError, "Missing the required parameter 'card_id' when calling CardsApi.get_widget_access_token"
      end
      # verify the required parameter 'widget_type' is set
      if @api_client.config.client_side_validation && widget_type.nil?
        fail ArgumentError, "Missing the required parameter 'widget_type' when calling CardsApi.get_widget_access_token"
      end
      # resource path
      local_var_path = '/cards/{card_id}/widget_token'.sub('{' + 'card_id' + '}', CGI.escape(card_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'WidgetToken'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"CardsApi.get_widget_access_token",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#get_widget_access_token\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :bulk_order_id 
    ...
    # @option opts [String] :bulk_order_config_id 
    # @option opts [Form] :form The format of the card
    # @option opts [String] :page_token 
    ...
    def list_cards_with_http_info(opts = {})
      ...
      query_params[:'bulk_order_id'] = opts[:'bulk_order_id'] if !opts[:'bulk_order_id'].nil?
      ...
      query_params[:'bulk_order_config_id'] = opts[:'bulk_order_config_id'] if !opts[:'bulk_order_config_id'].nil?
      query_params[:'form'] = opts[:'form'] if !opts[:'form'].nil?
      query_params[:'page_token'] = opts[:'page_token'] if !opts[:'page_token'].nil?
    ...
    def list_three_ds_decision_gateways(opts = {})
      data, _status_code, _headers = list_three_ds_decision_gateways_with_http_info(opts)
      data
    end
    ...
    # @option opts [String] :card_product_id 
    # @option opts [Integer] :limit  (default to 100)
    # @return [Array<(ThreeDsDecisionGatewayList, Integer, Hash)>] ThreeDsDecisionGatewayList data, response status code and response headers
    def list_three_ds_decision_gateways_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.list_three_ds_decision_gateways ...'
      end
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling CardsApi.list_three_ds_decision_gateways, must be greater than or equal to 1.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ThreeDsDecisionGatewayList'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"CardsApi.list_three_ds_decision_gateways",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#list_three_ds_decision_gateways\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # Update 3DS Decision Gateway 
    # @param id [String] 
    # @param update_three_ds_decision_gateway_request [UpdateThreeDsDecisionGatewayRequest] Updated 3DS Decision Gateway fields
    # @param [Hash] opts the optional parameters
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [ThreeDsDecisionGatewayResponse]
    def update_three_ds_gateway(id, update_three_ds_decision_gateway_request, opts = {})
      data, _status_code, _headers = update_three_ds_gateway_with_http_info(id, update_three_ds_decision_gateway_request, opts)
      data
    end
    ...
    # @option opts [String] :idempotency_key An idempotency key is an arbitrary unique value generated by client to detect subsequent retries of the same request. It is recommended that a UUID or a similar random identifier be used as an idempotency key. A different key must be used for each request, unless it is a retry.
    # @return [Array<(ThreeDsDecisionGatewayResponse, Integer, Hash)>] ThreeDsDecisionGatewayResponse data, response status code and response headers
    def update_three_ds_gateway_with_http_info(id, update_three_ds_decision_gateway_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: CardsApi.update_three_ds_gateway ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling CardsApi.update_three_ds_gateway"
      end
      # verify the required parameter 'update_three_ds_decision_gateway_request' is set
      if @api_client.config.client_side_validation && update_three_ds_decision_gateway_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_three_ds_decision_gateway_request' when calling CardsApi.update_three_ds_gateway"
      end
      # resource path
      local_var_path = '/cards/three_ds_decision_gateways/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_three_ds_decision_gateway_request)
      ...
      new_options = opts.merge(
        :operation => :"CardsApi.update_three_ds_gateway",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PATCH, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: CardsApi#update_three_ds_gateway\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
