...
module Synctera
  class CardProductResponse
    ...
    def hash
      [form, active, bin_country, card_brand, card_category, card_program_id, card_type, color, creation_time, cross_border_enabled, digital_wallet_tokenization, end_date, id, image, image_mode, issue_without_kyc, last_modified_time, name, orientation, package_id, physical_card_format, return_address, start_date, txn_enhancer, three_ds_policy].hash
    end
