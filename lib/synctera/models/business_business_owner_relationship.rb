...
module Synctera
  ...
  class BusinessBusinessOwnerRelationship
    ...
    attr_accessor :from_business_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::BusinessBusinessOwnerRelationship` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::BusinessBusinessOwnerRelationship`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @from_business_id.nil?
        invalid_properties.push('invalid value for "from_business_id", from_business_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @from_business_id.nil?
    ...
    def hash
      [additional_data, creation_time, from_business_id, id, last_updated_time, metadata, relationship_type, tenant, to_business_id].hash
    end
