...
module Synctera
  class TemplateFieldsDepository
    ...
    def hash
      [account_type, bank_country, currency, balance_ceiling, balance_floor, fee_product_ids, interest_product_id, is_ach_enabled, is_card_enabled, is_eft_ca_enabled, is_external_card_enabled, is_p2p_enabled, is_sar_enabled, is_wire_enabled, overdraft_limit, spend_control_ids, spending_limits].hash
    end
