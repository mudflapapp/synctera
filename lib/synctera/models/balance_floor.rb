...
module Synctera
  class BalanceFloor
    ...
    attr_accessor :overdraft_account_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::BalanceFloor` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::BalanceFloor`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'overdraft_account_id')
        self.overdraft_account_id = attributes[:'overdraft_account_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          overdraft_account_id == o.overdraft_account_id
    end
    ...
    def hash
      [balance, linked_account_id, overdraft_account_id].hash
    end
