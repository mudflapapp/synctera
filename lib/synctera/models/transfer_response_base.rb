...
module Synctera
  class TransferResponseBase
    ...
    def hash
      [account_id, amount, creation_time, currency, customer_id, external_card_id, id, last_updated_time, merchant, network_decline_details, reason, status, tenant, transaction_id].hash
    end
