  ...
  class DepositoryStatement
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::DepositoryStatement` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::DepositoryStatement`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'saving_summary')
        self.saving_summary = attributes[:'saving_summary']
      else
        self.saving_summary = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @saving_summary.nil?
        invalid_properties.push('invalid value for "saving_summary", saving_summary cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @saving_summary.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          saving_summary == o.saving_summary
    end
