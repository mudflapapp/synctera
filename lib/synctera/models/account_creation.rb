...
module Synctera
  class AccountCreation
    ...
    attr_accessor :manual_account_number
    ...
    def self.attribute_map
      {
        ...
        :'manual_account_number' => :'manual_account_number',
    ...
    def self.openapi_types
      {
        ...
        :'relationships' => :'Array<AccountRelationship>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::AccountCreation` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::AccountCreation`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'is_system_auto_pay_enabled')
        ...
        self.is_system_auto_pay_enabled = false
      end
      ...
      if attributes.key?(:'manual_account_number')
        self.manual_account_number = attributes[:'manual_account_number']
      end
    ...
    def list_invalid_properties
      ...
      if !@manual_account_number.nil? && @manual_account_number.to_s.length > 50
        invalid_properties.push('invalid value for "manual_account_number", the character length must be smaller than or equal to 50.')
      end

      pattern = Regexp.new(/^[0-9]{7,12}$/)
      if !@manual_account_number.nil? && @manual_account_number !~ pattern
        invalid_properties.push("invalid value for \"manual_account_number\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@manual_account_number.nil? && @manual_account_number.to_s.length > 50
      return false if !@manual_account_number.nil? && @manual_account_number !~ Regexp.new(/^[0-9]{7,12}$/)
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] manual_account_number Value to be assigned
    def manual_account_number=(manual_account_number)
      if manual_account_number.nil?
        fail ArgumentError, 'manual_account_number cannot be nil'
      end

      if manual_account_number.to_s.length > 50
        fail ArgumentError, 'invalid value for "manual_account_number", the character length must be smaller than or equal to 50.'
      end

      pattern = Regexp.new(/^[0-9]{7,12}$/)
      if manual_account_number !~ pattern
        fail ArgumentError, "invalid value for \"manual_account_number\", must conform to the pattern #{pattern}."
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          manual_account_number == o.manual_account_number &&
    ...
    def hash
      [balance_ceiling, balance_floor, fee_product_ids, interest_product_id, note, overdraft_limit, spend_control_ids, spending_limits, is_ach_enabled, is_card_enabled, is_eft_ca_enabled, is_external_card_enabled, is_p2p_enabled, is_synctera_pay_enabled, is_wire_enabled, access_status, account_number, account_number_masked, account_purpose, account_type, application_id, balances, bank_routing, creation_time, currency, customer_ids, customer_type, exchange_rate_type, iban, id, is_account_pool, is_sar_enabled, last_updated_time, metadata, nickname, status, swift_code, credit_limit, minimum_payment, general_ledger_type, is_system_auto_pay_enabled, security, grace_period, account_template_id, manual_account_number, relationships].hash
    end
