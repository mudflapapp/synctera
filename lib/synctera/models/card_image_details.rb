  ...
  class CardImageDetails
    ...
    def self.openapi_types
      {
        ...
        :'rejection_reason' => :'CardImageRejectionReason',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::CardImageDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::CardImageDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rejection_memo')
        self.rejection_memo = attributes[:'rejection_memo']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          rejection_memo == o.rejection_memo &&
    ...
    def hash
      [card_product_id, customer_id, id, rejection_memo, rejection_reason, status].hash
    end
