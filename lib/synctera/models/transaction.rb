...
module Synctera
  class Transaction
    ...
    def hash
      [account_id, amount, creation_time, currency, customer_id, dc_sign, decline, description, effective_date, enhanced_transaction, force_post, fraud_risk, group_id, hold_expiration_time, id, internal_account_id, last_updated_time, partial_hold, pending_amount, posted_amount, posted_date, reference_id, status, subtype, system_description, transaction_time, type].hash
    end
