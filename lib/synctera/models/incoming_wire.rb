  ...
  class IncomingWire
    ...
    def type_subtype=(type_subtype)
      ...
      unless validator.valid?(type_subtype)
        warn "invalid value for \"type_subtype\", must be one of #{validator.allowable_values}."
      end
      @type_subtype = type_subtype
    end
    ...
    def hash
      [account_id, amount, bank_message, creation_time, currency, customer_id, decline_reason, effective_date, id, input_message_accountability_data, is_return, network, originating_account_number, receiver, receiving_account_id, receiving_account_number, recipient_message, return_data, return_reason, sender, sender_reference_id, settlement_date, status, tenant, transaction_id, type_subtype].hash
    end
