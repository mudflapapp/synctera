  ...
  class EftCaResponse
    ...
    def network_status=(network_status)
      ...
      unless validator.valid?(network_status)
        warn "invalid value for \"network_status\", must be one of #{validator.allowable_values}."
      end
      @network_status = network_status
    end
    ...
    def subtype=(subtype)
      validator = EnumAttributeValidator.new('String', ["BULK_OUTGOING_CREDIT", "BULK_OUTGOING_CREDIT_RETURN", "BULK_OUTGOING_CREDIT_RETURN_REVERSAL", "BULK_OUTGOING_CREDIT_REVERSAL", "BULK_OUTGOING_DEBIT", "BULK_OUTGOING_DEBIT_RETURN", "BULK_OUTGOING_DEBIT_RETURN_REVERSAL", "BULK_OUTGOING_DEBIT_REVERSAL", "INCOMING_CREDIT", "INCOMING_CREDIT_RETURN", "INCOMING_CREDIT_RETURN_REVERSAL", "INCOMING_CREDIT_REVERSAL", "INCOMING_DEBIT", "INCOMING_DEBIT_RETURN", "INCOMING_DEBIT_RETURN_REVERSAL", "INCOMING_DEBIT_REVERSAL", "OUTGOING_CREDIT", "OUTGOING_CREDIT_RETURN", "OUTGOING_CREDIT_RETURN_REVERSAL", "OUTGOING_CREDIT_REVERSAL", "OUTGOING_DEBIT", "OUTGOING_DEBIT_RETURN", "OUTGOING_DEBIT_RETURN_REVERSAL", "OUTGOING_DEBIT_REVERSAL"])
