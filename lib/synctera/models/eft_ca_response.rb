...
module Synctera
  ...
  class EftCaResponse
    ...
    def valid?
      ...
      network_status_validator = EnumAttributeValidator.new('String', ["FAILED", "PENDING", "POSTED"])
    ...
    def network_status=(network_status)
      validator = EnumAttributeValidator.new('String', ["FAILED", "PENDING", "POSTED"])
    ...
    def hash
      [amount, customer_id, dc_sign, source_data, transaction_code, destination_account_id, destination_account_number, destination_account_owner_name, effective_date, history, id, is_same_day, network_status, originating_account_id, originating_account_number, originating_account_owner_name, posting_date, reference_id, status, subtype, tenant_id, transaction_id].hash
    end
