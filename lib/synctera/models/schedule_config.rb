  ...
  class ScheduleConfig
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::ScheduleConfig` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::ScheduleConfig`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'start_search')
        self.start_search = attributes[:'start_search']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @interval > 366
        invalid_properties.push('invalid value for "interval", must be smaller than or equal to 366.')
      end
    ...
    def valid?
      ...
      frequency_validator = EnumAttributeValidator.new('String', ["DAILY", "MONTHLY", "WEEKLY"])
      return false unless frequency_validator.valid?(@frequency)
      return false if @interval.nil?
      return false if @interval > 366
      return false if @interval < 1
      return false if @start_date.nil?
      start_search_validator = EnumAttributeValidator.new('String', ["BACKWARD", "FORWARD"])
      return false unless start_search_validator.valid?(@start_search)
      true
    end
    ...
    def frequency=(frequency)
      ...
      unless validator.valid?(frequency)
        warn "invalid value for \"frequency\", must be one of #{validator.allowable_values}."
      end
      @frequency = frequency
    end
    ...
    def interval=(interval)
      ...
      if interval > 366
        fail ArgumentError, 'invalid value for "interval", must be smaller than or equal to 366.'
      end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] start_search Object to be assigned
    def start_search=(start_search)
      validator = EnumAttributeValidator.new('String', ["BACKWARD", "FORWARD"])
      unless validator.valid?(start_search)
        warn "invalid value for \"start_search\", must be one of #{validator.allowable_values}."
      end
      @start_search = start_search
    end
    ...
    def hash
      [count, end_date, frequency, interval, start_date, start_search].hash
    end
