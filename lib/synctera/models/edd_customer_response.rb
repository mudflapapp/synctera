...
module Synctera
  class EddCustomerResponse
    ...
    def valid?
      ...
      employment_type_validator = EnumAttributeValidator.new('String', ["CONTRACTOR", "FULL_TIME", "INTERN", "OTHER", "PART_TIME", "RETIRED", "SELF_EMPLOYED", "STUDENT", "TEMPORARY", "UNEMPLOYED", "VOLUNTEER"])
    ...
    def employment_type=(employment_type)
      validator = EnumAttributeValidator.new('String', ["CONTRACTOR", "FULL_TIME", "INTERN", "OTHER", "PART_TIME", "RETIRED", "SELF_EMPLOYED", "STUDENT", "TEMPORARY", "UNEMPLOYED", "VOLUNTEER"])
      unless validator.valid?(employment_type)
        warn "invalid value for \"employment_type\", must be one of #{validator.allowable_values}."
      end
      @employment_type = employment_type
    end
    ...
    def residence_type=(residence_type)
      ...
      unless validator.valid?(residence_type)
        warn "invalid value for \"residence_type\", must be one of #{validator.allowable_values}."
      end
      @residence_type = residence_type
    end
    ...
    def hash
      [citizenship_countries, employment_type, income, negative_news_findings, occupation, occupation_industry, recurring_direct_deposit, residence_type, residential_expense, source_of_wealth, additional_questions, case_id, reason, related_resource_id, related_resource_type, tenant, creation_time, deletion_time, id].hash
    end
