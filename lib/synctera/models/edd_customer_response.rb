...
module Synctera
  class EddCustomerResponse
    ...
    def hash
      [citizenship_countries, employment_type, income, negative_news_findings, occupation, occupation_industry, recurring_direct_deposit, residence_type, residential_expense, source_of_wealth, amount, currency, frequency, additional_questions, case_id, reason, related_resource_id, related_resource_type, creation_time, deletion_time, id].hash
    end
