...
module Synctera
  ...
  class ExternalCardVerifications
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'pull_details')
        self.pull_details = attributes[:'pull_details']
      end
      ...
      if attributes.key?(:'push_details')
        self.push_details = attributes[:'push_details']
      end
    ...
    def address_verification_result=(address_verification_result)
      ...
      unless validator.valid?(address_verification_result)
        warn "invalid value for \"address_verification_result\", must be one of #{validator.allowable_values}."
      end
      @address_verification_result = address_verification_result
    end
    ...
    def cvv2_result=(cvv2_result)
      ...
      unless validator.valid?(cvv2_result)
        warn "invalid value for \"cvv2_result\", must be one of #{validator.allowable_values}."
      end
      @cvv2_result = cvv2_result
    end
    ...
    def name_verification_result=(name_verification_result)
      ...
      unless validator.valid?(name_verification_result)
        warn "invalid value for \"name_verification_result\", must be one of #{validator.allowable_values}."
      end
      @name_verification_result = name_verification_result
    end
    ...
    def state=(state)
      ...
      unless validator.valid?(state)
        warn "invalid value for \"state\", must be one of #{validator.allowable_values}."
      end
      @state = state
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          pull_details == o.pull_details &&
          pull_enabled == o.pull_enabled &&
          push_details == o.push_details &&
    ...
    def hash
      [address_verification_result, cvv2_result, name_verification_result, pull_details, pull_enabled, push_details, push_enabled, state].hash
    end
