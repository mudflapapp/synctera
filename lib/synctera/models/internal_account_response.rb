...
module Synctera
  class InternalAccountResponse
    ...
    def hash
      [account_number, account_type, balances, bank_routing, creation_time, currency, description, gl_type, id, is_system_acc, last_updated_time, purpose, status, tenant].hash
    end
