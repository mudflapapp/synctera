...
module Synctera
  ...
  class Deposit
    ...
    def valid?
      ...
      status_validator = EnumAttributeValidator.new('String', ["FAILED", "PENDING", "REJECTED", "SUBMITTED"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('String', ["FAILED", "PENDING", "REJECTED", "SUBMITTED"])
