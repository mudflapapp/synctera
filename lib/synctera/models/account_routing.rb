...
module Synctera
  class AccountRouting
    ...
    attr_accessor :correspondent_bank_details
    ...
    attr_accessor :eft_routing_number
    ...
    def self.openapi_types
      {
        ...
        :'bank_name' => :'String',
        :'correspondent_bank_details' => :'Array<CorrespondentBankDetails>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::AccountRouting` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::AccountRouting`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'correspondent_bank_details')
        if (value = attributes[:'correspondent_bank_details']).is_a?(Array)
          self.correspondent_bank_details = value
        end
      end
      ...
      if attributes.key?(:'eft_routing_number')
        self.eft_routing_number = attributes[:'eft_routing_number']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          correspondent_bank_details == o.correspondent_bank_details &&
          eft_ca_routing_number == o.eft_ca_routing_number &&
          eft_routing_number == o.eft_routing_number &&
    ...
    def hash
      [ach_routing_number, bank_address, bank_countries, bank_name, correspondent_bank_details, eft_ca_routing_number, eft_routing_number, swift_code, wire_routing_number].hash
    end
