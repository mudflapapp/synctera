...
module Synctera
  ...
  class OutgoingAch
    ...
    def hash
      [account_name, account_no, amount, bank_id, company_entry_description, company_name, effective_date, external_id, hold, id, is_same_day, memo, partner_id, reference_info, source_account_name, source_account_no, status, trace_no].hash
    end
