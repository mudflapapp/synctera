...
module Synctera
  ...
  class CardProduct
    ...
    def hash
      [form, active, card_program_id, color, creation_time, digital_wallet_tokenization, end_date, id, image, image_mode, issue_without_kyc, last_modified_time, name, orientation, package_id, physical_card_format, return_address, start_date, three_ds_policy, txn_enhancer].hash
    end
