...
module Synctera
  class ExternalAccount
    ...
    def hash
      [account_identifiers, account_owner_names, business_id, creation_time, currency, customer_id, deletion_time, id, last_updated_time, metadata, name, nickname, routing_identifiers, status, type, vendor_data, vendor_info, verification].hash
    end
