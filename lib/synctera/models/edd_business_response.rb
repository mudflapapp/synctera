...
module Synctera
  class EddBusinessResponse
    # The country where the business' hq is located.
    ...
    def hash
      [country, estimated_revenue, industry_type, specific_involvement, transaction_volume, additional_questions, case_id, reason, related_resource_id, related_resource_type, creation_time, deletion_time, id].hash
    end
