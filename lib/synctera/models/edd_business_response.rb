...
module Synctera
  class EddBusinessResponse
    # ISO-3166-1 Alpha-2 country code
    attr_accessor :country

    attr_accessor :estimated_revenue
    ...
    attr_accessor :recurring_wire_usage

    attr_accessor :specific_involvement
    ...
    def self.attribute_map
      {
        ...
        :'recurring_wire_usage' => :'recurring_wire_usage',
        :'specific_involvement' => :'specific_involvement',
    ...
    def self.openapi_types
      {
        ...
        :'recurring_wire_usage' => :'Boolean',
        :'specific_involvement' => :'SpecificInvolvement',
        :'transaction_volume' => :'Array<TransactionVolume>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::EddBusinessResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::EddBusinessResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'estimated_revenue')
        self.estimated_revenue = attributes[:'estimated_revenue']
      end
      ...
      if attributes.key?(:'recurring_wire_usage')
        self.recurring_wire_usage = attributes[:'recurring_wire_usage']
      end

      if attributes.key?(:'specific_involvement')
        self.specific_involvement = attributes[:'specific_involvement']
      end

      if attributes.key?(:'transaction_volume')
        if (value = attributes[:'transaction_volume']).is_a?(Array)
          self.transaction_volume = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if !@case_id.nil? && @case_id > 100000000000
        invalid_properties.push('invalid value for "case_id", must be smaller than or equal to 100000000000.')
      end

      if !@case_id.nil? && @case_id < 0
        invalid_properties.push('invalid value for "case_id", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@case_id.nil? && @case_id > 100000000000
    ...
    def case_id=(case_id)
      ...
      if case_id > 100000000000
        fail ArgumentError, 'invalid value for "case_id", must be smaller than or equal to 100000000000.'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          recurring_wire_usage == o.recurring_wire_usage &&
          specific_involvement == o.specific_involvement &&
    ...
    def hash
      [country, estimated_revenue, industry_type, negative_news_findings, recurring_wire_usage, specific_involvement, transaction_volume, additional_questions, case_id, reason, related_resource_id, related_resource_type, tenant, creation_time, deletion_time, id].hash
    end
