...
module Synctera
  class VirtualCardPlusStatus
    ...
    def hash
      [account_id, business_id, card_product_id, creation_time, customer_id, emboss_name, expiration_month, expiration_time, expiration_year, id, is_pin_set, last_four, last_updated_time, metadata, reissue_reason, reissued_from_id, reissued_to_id, timestamp_pin_set, form, card_status, memo, pending_reasons, status_reason].hash
    end
