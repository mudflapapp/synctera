...
module Synctera
  class TemplateFieldsGenericResponse
    ...
    def hash
      [account_type, auto_payment_period, balance_ceiling, balance_floor, bank_country, billing_period, currency, fee_product_ids, grace_period, interest_product_id, is_ach_enabled, is_card_enabled, is_eft_ca_enabled, is_external_card_enabled, is_p2p_enabled, is_sar_enabled, is_wire_enabled, minimum_payment, overdraft_limit, spend_control_ids, spending_limits].hash
    end
