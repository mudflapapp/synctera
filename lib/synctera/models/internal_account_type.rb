...
module Synctera
  class InternalAccountType
    ...
    def self.all_vars
      @all_vars ||= [ACH_SETTLEMENT, ACH_SUSPENSE, ALLOCATED_SUSPENSE, BILLING_EXPENSE, BILLING_REVENUE, CARD_AFT_PREFUNDING, CARD_OCT_SETTLEMENT, CARD_SETTLEMENT, CASH_SETTLEMENT, CASH_SUSPENSE, CHECK_SETTLEMENT, DISPUTE_WRITE_OFF_PNL, EFT_CA_SETTLEMENT, EFT_CA_SUSPENSE, EXTERNAL_CARD_AFT_SETTLEMENT, EXTERNAL_CARD_OCT_SETTLEMENT, FEDNOW_SETTLEMENT, FEES, FRAUD_LOSSES, FUNDING_ACCOUNTS, GENERAL_PNL, INTEREST_PAYOUT, LOC_INTEREST_INCOME, LOC_INVESTOR_PORTFOLIO, LOC_REPURCHASE, MONEY_IN_AND_OUT, NETWORK_ADJUSTMENT, NETWORK_CHARGEBACK, NEW_FUNDING_ACCOUNT, PROVISIONAL_CREDIT_PNL, RESERVE, REWARDS, USC_INTEREST_INCOME, USC_INVESTOR_PORTFOLIO, USC_REPURCHASE, WIRE_SETTLEMENT, WIRE_SUSPENSE, WRITE_OFF].freeze
    end
