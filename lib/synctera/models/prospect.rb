...
module Synctera
  ...
  class Prospect
    ...
    def self.openapi_types
      {
        ...
        :'note' => :'String',
        :'phone_number' => :'String',
        :'related_customers' => :'Array<Relationship1>',
    ...
    def hash
      [ban_status, creation_time, email, has_accounts, id, kyc_exempt, kyc_last_run, kyc_status, last_updated_time, legal_address, metadata, middle_name, note, phone_number, related_customers, shipping_address, ssn, ssn_source, tenant, dob, first_name, last_name, status].hash
    end
