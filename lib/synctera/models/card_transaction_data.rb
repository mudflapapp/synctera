  ...
  class CardTransactionData
    ...
    def self.openapi_types
      {
        ...
        :'currency_conversion' => :'CardTransactionDataCurrencyConversion',
        :'merchant' => :'CardTransactionDataMerchant',
        :'network' => :'String',
        :'network_reference_id' => :'String',
        :'pos' => :'CardTransactionDataPos'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::CardTransactionData` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::CardTransactionData`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [card_id, currency_code, currency_conversion, merchant, network, network_reference_id, pos].hash
    end
