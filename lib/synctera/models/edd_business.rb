...
module Synctera
  class EddBusiness
    ...
    def hash
      [additional_questions, case_id, reason, related_resource_id, related_resource_type, country, estimated_revenue, industry_type, specific_involvement, transaction_volume].hash
    end
