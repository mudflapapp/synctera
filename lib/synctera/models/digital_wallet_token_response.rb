...
module Synctera
  class DigitalWalletTokenResponse
    ...
    def hash
      [approved_time, card_id, device, device_id, device_type, id, last_updated_time, processor_data, removed_from_wallet_time, requested_time, state, tenant, token_reference_id, type].hash
    end
