...
module Synctera
  class SpendControlResponse
    ...
    def hash
      [action_case, action_decline, amount_limit, creation_time, direction, id, is_active, last_modified_time, managed_by, merchant_category_codes, name, payment_sub_types, payment_types, time_range, number_of_related_accounts, tenant].hash
    end
