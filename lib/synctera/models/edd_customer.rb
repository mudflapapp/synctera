...
module Synctera
  class EddCustomer
    ...
    def hash
      [additional_questions, case_id, reason, related_resource_id, related_resource_type, tenant, citizenship_countries, employment_type, income, negative_news_findings, occupation, occupation_industry, recurring_direct_deposit, residence_type, residential_expense, source_of_wealth].hash
    end
