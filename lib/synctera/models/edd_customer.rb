...
module Synctera
  class EddCustomer
    ...
    def hash
      [amount, currency, frequency, additional_questions, case_id, reason, related_resource_id, related_resource_type, employment_type, income, occupation, occupation_industry, residence_type, residential_expense].hash
    end
