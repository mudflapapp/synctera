...
module Synctera
  class PatchAccountChargeUnsecured
    ...
    def hash
      [access_status, account_number, account_number_masked, account_purpose, account_type, application_id, balances, bank_routing, creation_time, currency, customer_ids, customer_type, exchange_rate_type, iban, id, is_account_pool, is_sar_enabled, last_updated_time, metadata, nickname, status, swift_code, credit_limit, grace_period, is_ach_enabled, is_card_enabled, is_eft_ca_enabled, is_p2p_enabled, is_wire_enabled, note, spend_control_ids].hash
    end
