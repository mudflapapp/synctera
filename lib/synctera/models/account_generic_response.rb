...
module Synctera
  class AccountGenericResponse
    ...
    def hash
      [access_status, access_status_last_updated_time, account_number, account_number_masked, account_purpose, account_type, application_id, auto_payment_period, balance_ceiling, balance_floor, balances, bank_routing, billing_period, business_ids, close_date, creation_time, credit_limit, currency, customer_ids, customer_type, exchange_rate_type, fee_product_ids, grace_period, iban, id, interest_product_id, is_account_pool, is_ach_enabled, is_card_enabled, is_eft_ca_enabled, is_external_card_enabled, is_p2p_enabled, is_sar_enabled, is_security, is_system_auto_pay_enabled, is_wire_enabled, last_updated_time, metadata, minimum_payment, nickname, open_date, overdraft_limit, restrictions, security, spend_control_ids, spending_limits, status, swift_code, tenant].hash
    end
