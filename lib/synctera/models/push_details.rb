...
module Synctera
  # Additional PUSH transfer details
  class PushDetails
    ...
    def self.openapi_types
      {
        :'country' => :'String',
        :'currency' => :'String',
        :'funds_availability' => :'ExternalCardsFundsAvailability',
        :'network' => :'String',
        :'product_type' => :'ExternalCardProductType',
        :'regulated' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::PushDetails` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::PushDetails`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'funds_availability')
        self.funds_availability = attributes[:'funds_availability']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          country == o.country &&
          currency == o.currency &&
          funds_availability == o.funds_availability &&
          network == o.network &&
    ...
    def hash
      [country, currency, funds_availability, network, product_type, regulated].hash
    end
