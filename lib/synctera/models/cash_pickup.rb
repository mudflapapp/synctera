  ...
  class CashPickup
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::CashPickup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::CashPickup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'scheduled_pickup_date')
        ...
        self.scheduled_pickup_date = nil
      end
    ...
    def list_invalid_properties
      ...
      if @employee_customer_id.nil?
        invalid_properties.push('invalid value for "employee_customer_id", employee_customer_id cannot be nil.')
      end
      ...
      if @scheduled_pickup_date.nil?
        invalid_properties.push('invalid value for "scheduled_pickup_date", scheduled_pickup_date cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @employee_customer_id.nil?
      return false if @id.nil?
      return false if @last_updated_time.nil?
      return false if @reference_id.nil?
      return false if @scheduled_pickup_date.nil?
    ...
    def hash
      [account_id, amount, business_id, creation_time, currency, employee_customer_id, id, last_updated_time, metadata, pickup_time, posted_amount, posted_date, reference_id, scheduled_pickup_date, transaction_id, status].hash
    end
