...
module Synctera
  class AddAccountsRequest
    ...
    def hash
      [account_identifiers, account_owner_names, business_id, currency, customer_id, customer_type, metadata, nickname, routing_identifiers, tenant, type, vendor_account_id, verification].hash
    end
