...
module Synctera
  class FdxTokenResponse
    ...
    attr_accessor :token_expiry_time
    ...
    def self.openapi_types
      {
        ...
        :'status' => :'FdxTokenStatus',
        :'tenant' => :'String',
        :'token_expiry_time' => :'Time',
        :'token_hash' => :'String',
        :'token_type' => :'FdxTokenType'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::FdxTokenResponse` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::FdxTokenResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'parent_token_id')
        self.parent_token_id = attributes[:'parent_token_id']
      end
      ...
      if attributes.key?(:'token_expiry_time')
        self.token_expiry_time = attributes[:'token_expiry_time']
      else
        self.token_expiry_time = nil
      end
    ...
    def list_invalid_properties
      ...
      if @token_expiry_time.nil?
        invalid_properties.push('invalid value for "token_expiry_time", token_expiry_time cannot be nil.')
      end

      if @token_hash.nil?
        invalid_properties.push('invalid value for "token_hash", token_hash cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @token_expiry_time.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          parent_token_id == o.parent_token_id &&
          status == o.status &&
          tenant == o.tenant &&
          token_expiry_time == o.token_expiry_time &&
    ...
    def hash
      [business_id, creation_time, customer_id, id, last_updated_time, parent_token_id, status, tenant, token_expiry_time, token_hash, token_type].hash
    end
