  ...
  class FeeTransaction
    ...
    def self.openapi_types
      {
        ...
        :'fee_transaction' => :'FeeTransactionData',
        :'subtype' => :'FeeSubtype'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::FeeTransaction` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::FeeTransaction`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fee_transaction')
        self.fee_transaction = attributes[:'fee_transaction']
      else
        self.fee_transaction = nil
      end
    ...
    def list_invalid_properties
      ...
      if @fee_transaction.nil?
        invalid_properties.push('invalid value for "fee_transaction", fee_transaction cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @fee_transaction.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          type == o.type &&
          fee_transaction == o.fee_transaction &&
          subtype == o.subtype
    end
    ...
    def hash
      [account_id, amount, creation_time, currency, customer_id, dc_sign, decline, description, effective_date, enhanced_transaction, force_post, fraud_risk, group_id, hold_expiration_time, id, internal_account_id, last_updated_time, metadata, partial_hold, pending_amount, posted_amount, posted_date, reference_id, status, system_description, transaction_time, type, fee_transaction, subtype].hash
    end
