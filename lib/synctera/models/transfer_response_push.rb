...
module Synctera
  class TransferResponsePush
    ...
    def hash
      [account_id, amount, country_code, created_time, currency, customer_id, external_card_id, id, last_modified_time, merchant, status, transaction_id, type, originating_customer_id].hash
    end
