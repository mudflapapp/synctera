...
module Synctera
  ...
  class Payment
    ...
    attr_accessor :payment_schedule_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Synctera::Payment` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Synctera::Payment`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'payment_schedule_id')
        self.payment_schedule_id = attributes[:'payment_schedule_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          payment_schedule_id == o.payment_schedule_id &&
          status == o.status &&
    ...
    def hash
      [description, error_details, id, metadata, payment_date, payment_instruction, payment_schedule_id, status, transaction_id].hash
    end
