...
module Synctera
  class Wire
    ...
    def hash
      [amount, bank_message, creation_time, currency, customer_id, effective_date, id, last_updated_time, originating_account_id, originating_account_number, receiving_account_id, receiving_account_number, recipient_message, return_data, sender_reference_id, status, status_details, transaction_id, transaction_in_id].hash
    end
