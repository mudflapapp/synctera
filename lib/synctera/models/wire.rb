  ...
  class Wire
    ...
    def status_details=(status_details)
      ...
      unless validator.valid?(status_details)
        warn "invalid value for \"status_details\", must be one of #{validator.allowable_values}."
      end
      @status_details = status_details
    end
    ...
    def hash
      [amount, bank_message, batch_id, case_id, creation_time, currency, customer_id, effective_date, id, input_message_accountability_data, is_bulk, last_updated_time, network, originating_account_id, originating_account_number, receiving_account_id, receiving_account_number, recipient_message, return_data, sender_reference_id, settlement_date, status, status_details, transaction_id, transaction_in_id].hash
    end
