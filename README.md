...
*Synctera::TransactionsInternalApi* | [**get_transactions_batch_payments**](docs/TransactionsInternalApi.md#get_transactions_batch_payments) | **GET** /transactions/batchable | Get Transactions From Batch Payments Templates
