...
*Synctera::CashPickupsAlphaApi* | [**create_cash_pickup**](docs/CashPickupsAlphaApi.md#create_cash_pickup) | **POST** /cash_pickups | Create a cash pickup
*Synctera::CashPickupsAlphaApi* | [**get_cash_pickup**](docs/CashPickupsAlphaApi.md#get_cash_pickup) | **GET** /cash_pickups/{cash_pickup_id} | Get a cash pickup
*Synctera::CashPickupsAlphaApi* | [**list_cash_pickups**](docs/CashPickupsAlphaApi.md#list_cash_pickups) | **GET** /cash_pickups | List cash pickups
*Synctera::CashPickupsAlphaApi* | [**patch_cash_pickup**](docs/CashPickupsAlphaApi.md#patch_cash_pickup) | **PATCH** /cash_pickups/{cash_pickup_id} | Update a cash pickup
*Synctera::CustomersApi* | [**create_customer**](docs/CustomersApi.md#create_customer) | **POST** /customers | Create a Customer
*Synctera::CustomersApi* | [**create_customer_employment**](docs/CustomersApi.md#create_customer_employment) | **POST** /customers/{customer_id}/employment | Create employment record
*Synctera::CustomersApi* | [**create_customer_risk_rating**](docs/CustomersApi.md#create_customer_risk_rating) | **POST** /customers/{customer_id}/risk_ratings | Create customer risk rating
*Synctera::CustomersApi* | [**get_all_customer_employment**](docs/CustomersApi.md#get_all_customer_employment) | **GET** /customers/{customer_id}/employment | List customer employment records
*Synctera::CustomersApi* | [**get_all_customer_risk_ratings**](docs/CustomersApi.md#get_all_customer_risk_ratings) | **GET** /customers/{customer_id}/risk_ratings | List customer risk ratings
*Synctera::CustomersApi* | [**get_customer**](docs/CustomersApi.md#get_customer) | **GET** /customers/{customer_id} | Get Customer
*Synctera::CustomersApi* | [**get_customer_risk_rating**](docs/CustomersApi.md#get_customer_risk_rating) | **GET** /customers/{customer_id}/risk_ratings/{risk_rating_id} | Get customer risk rating
*Synctera::CustomersApi* | [**get_party_employment**](docs/CustomersApi.md#get_party_employment) | **GET** /customers/{customer_id}/employment/{employment_id} | Get customer employment record
...
*Synctera::CustomersApi* | [**update_party_employment**](docs/CustomersApi.md#update_party_employment) | **PUT** /customers/{customer_id}/employment/{employment_id} | Update customer employment record
...
*Synctera::EFTCanadaAlphaApi* | [**create_eftca_transfer**](docs/EFTCanadaAlphaApi.md#create_eftca_transfer) | **POST** /eft_ca | Create EFT Canada Transfer
*Synctera::EFTCanadaAlphaApi* | [**get_eftca_transfer**](docs/EFTCanadaAlphaApi.md#get_eftca_transfer) | **GET** /eft_ca/{id} | Get EFT Canada Transfer
*Synctera::EFTCanadaAlphaApi* | [**get_eftca_transfers**](docs/EFTCanadaAlphaApi.md#get_eftca_transfers) | **GET** /eft_ca | Get EFT Canada Transfers
*Synctera::EFTCanadaAlphaApi* | [**patch_eftca_transfer**](docs/EFTCanadaAlphaApi.md#patch_eftca_transfer) | **PATCH** /eft_ca/{id} | Update a EFT Canada Transfer
*Synctera::EFTCanadaAlphaApi* | [**return_eftca_transfer**](docs/EFTCanadaAlphaApi.md#return_eftca_transfer) | **POST** /eft_ca/{id}/return | Return an EFT Canada Transfer
...
*Synctera::InternationalWiresAlphaApi* | [**create_international_wire**](docs/InternationalWiresAlphaApi.md#create_international_wire) | **POST** /international_wires | Create an International Wire
*Synctera::InternationalWiresAlphaApi* | [**get_international_wire**](docs/InternationalWiresAlphaApi.md#get_international_wire) | **GET** /international_wires/{wire_id} | Get an international wire by id
*Synctera::InternationalWiresAlphaApi* | [**list_international_wires**](docs/InternationalWiresAlphaApi.md#list_international_wires) | **GET** /international_wires | List International Wires
*Synctera::InternationalWiresAlphaApi* | [**patch_international_wire**](docs/InternationalWiresAlphaApi.md#patch_international_wire) | **PATCH** /international_wires/{wire_id} | Update an international wire to various statuses
...
*Synctera::WatchlistDeprecatedApi* | [**get_watchlist_alert**](docs/WatchlistDeprecatedApi.md#get_watchlist_alert) | **GET** /customers/{customer_id}/watchlists/alerts/{alert_id} | Retrieve watchlist monitoring alert
*Synctera::WatchlistDeprecatedApi* | [**get_watchlist_subscription**](docs/WatchlistDeprecatedApi.md#get_watchlist_subscription) | **GET** /customers/{customer_id}/watchlists/subscriptions/{subscription_id} | Retrieve watchlist monitoring subscription
*Synctera::WatchlistDeprecatedApi* | [**list_watchlist_alerts**](docs/WatchlistDeprecatedApi.md#list_watchlist_alerts) | **GET** /customers/{customer_id}/watchlists/alerts | List watchlist monitoring alerts for a customer
...
*Synctera::WatchlistDeprecatedApi* | [**suppress_watchlist_entity_alert**](docs/WatchlistDeprecatedApi.md#suppress_watchlist_entity_alert) | **POST** /customers/{customer_id}/watchlists/suppressions | Suppress entity alert
...
*Synctera::WatchlistDeprecatedApi* | [**watchlist_subscribe**](docs/WatchlistDeprecatedApi.md#watchlist_subscribe) | **POST** /customers/{customer_id}/watchlists/subscriptions | Subscribe a customer to watchlist monitoring
...
*Synctera::WiresApi* | [**get_wire**](docs/WiresApi.md#get_wire) | **GET** /wires/{wire_id} | Get a wire by id
*Synctera::WiresApi* | [**list_wires**](docs/WiresApi.md#list_wires) | **GET** /wires | List wires
...
## Documentation for Models
 ...
 - [Synctera::BaseCashPickup](docs/BaseCashPickup.md)
 - [Synctera::BaseDisclosure](docs/BaseDisclosure.md)
 - [Synctera::BasePerson](docs/BasePerson.md)
 - [Synctera::BasePerson1](docs/BasePerson1.md)
 ...
 - [Synctera::CashPickup](docs/CashPickup.md)
 - [Synctera::CashPickupList](docs/CashPickupList.md)
 - [Synctera::CashPickupPatchRequest](docs/CashPickupPatchRequest.md)
 - [Synctera::CashPickupPostRequest](docs/CashPickupPostRequest.md)
 - [Synctera::CashPickupStatus](docs/CashPickupStatus.md)
 ...
 - [Synctera::Document](docs/Document.md)
 ...
 - [Synctera::Employment](docs/Employment.md)
 - [Synctera::EmploymentList](docs/EmploymentList.md)
 - [Synctera::Encryption](docs/Encryption.md)
 ...
 - [Synctera::InternationalWireList](docs/InternationalWireList.md)
 - [Synctera::InternationalWirePatch](docs/InternationalWirePatch.md)
 - [Synctera::InternationalWirePost](docs/InternationalWirePost.md)
 - [Synctera::InternationalWireResponse](docs/InternationalWireResponse.md)
 - [Synctera::InternationalWireStatus](docs/InternationalWireStatus.md)
 ...
 - [Synctera::PatchDocument](docs/PatchDocument.md)
 ...
 - [Synctera::Relationship1](docs/Relationship1.md)
 ...
 - [Synctera::RiskRating](docs/RiskRating.md)
 - [Synctera::RiskRatingList](docs/RiskRatingList.md)
 ...
 - [Synctera::Status](docs/Status.md)
 - [Synctera::Status1](docs/Status1.md)
 - [Synctera::Status2](docs/Status2.md)
 ...
 - [Synctera::VerificationType1](docs/VerificationType1.md)
 ...
 - [Synctera::WatchlistAlertList](docs/WatchlistAlertList.md)
 ...
 - [Synctera::WatchlistSuppress](docs/WatchlistSuppress.md)
